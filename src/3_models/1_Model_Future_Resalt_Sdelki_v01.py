...
Dammi_Pattern_Rezultat_Sdelki_Cub_Summ_60Day_3Mmax_Svertka = pd.get_dummies(dataset['Pattern_Rezultat_Sdelki_Cub_Summ_60Day_3Mmax_Svertka'])
Dammi_Pattern_Rezultat_Sdelki_Cub_Summ_60Day_1Mmax_Svertka = pd.get_dummies(dataset['Pattern_Rezultat_Sdelki_Cub_Summ_60Day_1Mmax_Svertka'])
...
dataset2['Line_Regression_Predict'] = lasso.predict(X)
dataset2['Delta_X_Y'] = dataset2['Line_Regression_Predict'] - dataset2['<CLOSE>']
dataset2['Delta%_X_Y'] = dataset2['Delta_X_Y'] / dataset2['<CLOSE>'] * 100
...
(lasso.coef_).to_csv('D://GitHub/Forex-and-Stock-Python-Trade-Model/data/interim/7_ML_lasso_coef.txt', startrow=3, index=True)
