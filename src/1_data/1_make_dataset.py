...
trade_cube = data_preprocessing.data_frame_inicialization(trade_cube, 'D://GitHub/Saint_Perersburg_Trading_Model_a/data/external/SPFB.RTS/', ',')
usd_rub = data_preprocessing.data_frame_inicialization(usd_rub, 'D://GitHub/Saint_Perersburg_Trading_Model_a/data/external/USD_RUB/', ';')
...
data_preprocessing.data_frame_write(trade_cube, 'D://GitHub/Saint_Perersburg_Trading_Model_a/data/interim/1_Trade_Cube_1.txt')
