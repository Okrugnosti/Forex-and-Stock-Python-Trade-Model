...
trade_cube = pd.read_csv('D://GitHub/Saint_Perersburg_Trading_Model_a/data/interim/1_Trade_Cube_1.txt', sep=',')
...
data_preprocessing.data_frame_write(trade_cube, 'D://GitHub/Saint_Perersburg_Trading_Model_a/data/interim/2_Resalt_Trade_Model_1.txt')
#trade_cube.to_excel('D://GitHub/Saint_Perersburg_Trading_Model_a/data/interim/2_Resalt_Trade_Model_1.xlsx', startrow=3, index=True)
